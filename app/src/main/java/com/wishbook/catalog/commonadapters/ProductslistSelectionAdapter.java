...
public class ProductslistSelectionAdapter extends RecyclerView.Adapter<ProductslistSelectionAdapter.CustomViewHolder> {
    private String selectionId="0";
    private boolean delete = false;
    private ArrayList<ProductObj> feedItemList;
    private AppCompatActivity mContext;

    public ProductslistSelectionAdapter(AppCompatActivity context, ArrayList<ProductObj> feedItemList,String selectionId,boolean delete) {
...
/*
    ...
    public void onBindViewHolder(final CustomViewHolder customViewHolder, final int i) {
        if(feedItemList.get(i).getSku()!=null &&  !feedItemList.get(i).getSku().equals("null") && !feedItemList.get(i).getSku().equals("")) {
            customViewHolder.prod_name.setVisibility(View.VISIBLE);
            customViewHolder.prod_name.setText(feedItemList.get(i).getSku());
        }else{
