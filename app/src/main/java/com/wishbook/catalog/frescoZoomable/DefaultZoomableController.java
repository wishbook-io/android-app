...
public class DefaultZoomableController
    ...
    public boolean isZoomResetAvailable;
    ...
    @Override
    public void setResetAvailable(boolean isResetAvailable) {
        isZoomResetAvailable = isResetAvailable;
    }

    @Override
    public boolean isResetAvailable() {
        return isZoomResetAvailable;
    }
    ...
    @Override
    public void onGestureEnd(TransformGestureDetector detector, boolean zoomEnd) {
        FLog.v(TAG, "onGestureEnd");
        onTransformEnd();
        if(isZoomResetAvailable){
            if (zoomEnd) {
                Log.e("TAG", "MultiPointerGestureDetector: zoom reset");
                reset();
                onResetZoom();
                if(zoomGestureListener!=null){
                    zoomGestureListener.zoomReset();
                }
            }
        }
    ...
    public void statisetzoomGestureListener(ZoomGestureListener zoomGestureListener) {
