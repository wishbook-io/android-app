...
public class MultiPointerGestureDetector {
    ...
    public interface Listener {
         ...
         */
        public void onGestureEnd(MultiPointerGestureDetector detector, boolean zoomEnd);
    }
     ...
     */
    private void stopGesture(boolean zoomEnd) {
        if (mGestureInProgress) {
            mGestureInProgress = false;
            if (mListener != null) {
                mListener.onGestureEnd(this, zoomEnd);
            }
        }
    }
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        Log.e("TAG", "onTouchEvent: MultiPointer GestureDetector Touchevent" );
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_MOVE: {
                Log.e("TAG", "MultiPointerGestureDetector: ACTION_MOVE");
                // update pointers
            ...
            case MotionEvent.ACTION_POINTER_UP:
                Log.e("TAG", "MultiPointerGestureDetector: ACTION_POINTER_UP");
            ...
            case MotionEvent.ACTION_UP: {
                Log.e("TAG", "MultiPointerGestureDetector: ACTION_UP");
            ...
            case MotionEvent.ACTION_CANCEL: {
                Log.e("TAG", "MultiPointerGestureDetector: ACTION_CANCEL");
                mNewPointerCount = 0;
                stopGesture();
                reset();
