...
public class ChildCategory {
    ...
    private Integer id;
    private List<ChildCategory_> child_category = new ArrayList<ChildCategory_>();
     ...
     *     The child_category
     */
    public List<ChildCategory_> getchild_category() {
     ...
     *     The child_category
     */
    public void setchild_category(List<ChildCategory_> child_category) {
