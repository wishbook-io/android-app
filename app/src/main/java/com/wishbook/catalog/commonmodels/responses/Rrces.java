...
public class Rrces implements Serializable {
    ...
    {
        return "ClassPojo [request_status = "+request_status+", return_type = "+return_type+", return_courier = "+return_courier+", total_discount = "+total_discount+", request_type = "+request_type+", rrc_items = "+rrc_items+", created = "+created+", total_qty = "+total_qty+", total_rate = "+total_rate+", request_reason_text = "+request_reason_text+", total_tax = "+total_tax+", return_awb_no = "+return_awb_no+", replacement_order_id = "+replacement_order_id+", uniware_reverse_pickup_code = "+uniware_reverse_pickup_code+", uniware_return_invoice_id = "+uniware_return_invoice_id+", invoice_id = "+invoice_id+", modified = "+modified+", id = "+id+", refund = "+refund+", return_shipment_status = "+return_shipment_status+", order = "+order+"]";
    }
}
