    ...
    static final class Reader implements FrameReader {
            ...
            public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
                ...
                if (!control) {
                    ...
                    if (length == 0) {
                        ...
                        // fixes the hanging response portion of https://github.com/vignesh/ion/issues/443#issuecomment-67729152
            ...
            public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
                ...
                try {
                    ...
                    switch (type) {
                        ...
                        case TYPE_GOAWAY:
                            readGoAway(bb, length);
                            break;

                        case TYPE_HEADERS:
                            readHeaders(bb, length);
                            break;

                        case TYPE_WINDOW_UPDATE:
                            readWindowUpdate(bb, length);
                            break;
        ...
        */
        ...
        private void readSynStream(ByteBufferList source, int flags, int length) throws IOException {
            ...
            handler.headers(inFinished, streamId, headerBlock,
        ...
        private void readSynReply(ByteBufferList source, int flags, int length) throws IOException {
            ...
            boolean inFinished = (flags & FLAG_FIN) != 0;
            handler.headers(inFinished, streamId, headerBlock, HeadersMode.SPDY_REPLY);
        }

        private void readRstStream(ByteBufferList source, int length) throws IOException {
        ...
        private void readHeaders(ByteBufferList source, int length) throws IOException {
            int w1 = source.getInt();
            int streamId = w1 & 0x7fffffff;
            List<Header> headerBlock = headerReader.readHeader(source, length - 4);
            handler.headers(false, streamId, headerBlock, HeadersMode.SPDY_HEADERS);
        }

        private void readWindowUpdate(ByteBufferList source, int length) throws IOException {
        ...
        private void readPing(ByteBufferList source, int length) throws IOException {
        ...
        private void readGoAway(ByteBufferList source, int length) throws IOException {
            ...
            handler.goAway(lastGoodStreamId);
        }
