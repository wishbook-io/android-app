...
import com.wishbook.catalog.Utils.networking.builder.BitmapFutureBuilder;
 ...
 */
abstract class NetworkProcessorBitmapRequestBuilder implements BitmapFutureBuilder, Builders.Any.BF {
    ...
    public NetworkProcessorBitmapRequestBuilder(NetworkProcessorRequestBuilder builder) {
        this.builder = builder;
        ion = builder.ion;
    }

    public NetworkProcessorBitmapRequestBuilder(NetworkProcessor ion) {
        this.ion = ion;
    }
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder transform(Transform transform) {
        if (transform == null)
            return this;
        if (transforms == null)
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder postProcess(PostProcess postProcess) {
    ...
    public static String computeDecodeKey(NetworkProcessorRequestBuilder builder, int resizeWidth, int resizeHeight, boolean animateGif, boolean deepZoom) {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder centerCrop() {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder fitXY() {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder fitCenter() {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder centerInside() {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder resize(int width, int height) {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder resizeWidth(int width) {
        return resize(width, 0);
    }

    @Override
    public NetworkProcessorBitmapRequestBuilder resizeHeight(int height) {
        return resize(0, height);
    }

	public NetworkProcessorBitmapRequestBuilder smartSize(boolean smartSize) {
    ...
    @Override
    public NetworkProcessorBitmapRequestBuilder animateGif(AnimateGifMode mode) {
        this.animateGifMode = mode;
        return this;
    }

    @Override
    public NetworkProcessorBitmapRequestBuilder deepZoom() {
