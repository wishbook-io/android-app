package com.wishbook.catalog.Utils.multipleimageselect.activities;
...
import com.wishbook.catalog.Utils.multipleimageselect.adapters.CustomAlbumSelectAdapter;
...
public class AlbumSelectActivity extends AppCompatActivity {
    ...
    private boolean isOneShotSelection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getBooleanExtra("isoneshotselection",false)) {
            isOneShotSelection = true;
        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("isoneshotselection",isOneShotSelection);
    ...
    private class AlbumLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            //abu adding this code for sorting by name
            Collections.sort(albums, new Comparator<Album>() {
                @Override
                public int compare(Album album, Album t1) {
                    if(album!=null && album.name!=null && t1!=null && t1.name!=null)
