 ...
 */
public class NetworkProcessorBitmapCache {
    ...
    public NetworkProcessorBitmapCache(NetworkProcessor ion) {
    ...
    public BitmapInfo get(String key) {
        ...
        if (ret.bitmap != null && ret.bitmap.isRecycled()) {
            ...
            Log.w("ION", "This may happen if passing NetworkProcessor bitmaps directly to notification builders or remote media clients.");
    ...
    public void dump() {
        Log.i("NProcessBitmapCache", "bitmap cache: " + cache.size());
        Log.i("NProcessBitmapCache", "freeMemory: " + Runtime.getRuntime().freeMemory());
    }
