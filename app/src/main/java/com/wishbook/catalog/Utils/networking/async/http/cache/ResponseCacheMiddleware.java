package com.wishbook.catalog.Utils.networking.async.http.cache;
...
import com.wishbook.catalog.Utils.networking.async.http.AsyncHttpClientMiddleware;
...
import com.wishbook.catalog.Utils.networking.async.util.Allocator;
...
public class ResponseCacheMiddleware extends SimpleMiddleware {
    ...
    public void onBodyDecoder(OnBodyDataOnRequestSentData data) {
        CachedSocket cached = com.wishbook.catalog.Utils.networking.async.Util.getWrappedSocket(data.socket, CachedSocket.class);
        if (cached != null) {
