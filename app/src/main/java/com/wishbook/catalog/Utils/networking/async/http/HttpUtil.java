...
import com.wishbook.catalog.Utils.networking.async.http.filter.ChunkedInputFilter;
import com.wishbook.catalog.Utils.networking.async.http.filter.ContentLengthFilter;
import com.wishbook.catalog.Utils.networking.async.http.filter.GZIPInputFilter;
import com.wishbook.catalog.Utils.networking.async.http.filter.InflaterInputFilter;

public class HttpUtil {
    public static AsyncHttpRequestBody getBody(Headers headers) {
