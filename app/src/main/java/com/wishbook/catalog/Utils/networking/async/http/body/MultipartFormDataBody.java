...
import com.wishbook.catalog.Utils.networking.async.LineEmitter;
import com.wishbook.catalog.Utils.networking.async.LineEmitter.StringCallback;
import com.wishbook.catalog.Utils.networking.async.callback.CompletedCallback;
import com.wishbook.catalog.Utils.networking.async.callback.ContinuationCallback;
import com.wishbook.catalog.Utils.networking.async.callback.DataCallback;
import com.wishbook.catalog.Utils.networking.async.future.Continuation;
...
import com.wishbook.catalog.Utils.networking.async.http.server.BoundaryEmitter;
        ...
        for (final Part part: mParts) {
            c.add(new ContinuationCallback() {
                ...
                public void onContinue(CompletedCallback next) throws Exception {
                    ...
                    com.wishbook.catalog.Utils.networking.async.Util.writeAll(sink, bytes, next);
