...
public class CallbackLocationFetchingCheckOutActivity extends FragmentActivity implements
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {

    public static final String TAG = CallbackLocationFetchingCheckOutActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wishbook_gps_main_layout_checkout);
        mContext = this;
        //setUpMapIfNeeded();
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(CallbackLocationFetchingCheckOutActivity.this, REQUEST_CHECK_SETTINGS);
                        } catch (IntentSender.SendIntentException e) {
                            // Ignore the error.
            ...
            case REQUEST_CHECK_SETTINGS:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        Toast.makeText(CallbackLocationFetchingCheckOutActivity.this, "Fetching location please wait", Toast.LENGTH_LONG).show();
                        break;
                    case Activity.RESULT_CANCELED:
                        // The user was asked to change settings, but chose not to
                        Toast.makeText(CallbackLocationFetchingCheckOutActivity.this, "Unable to get your location", Toast.LENGTH_LONG).show();
                        finish();
                        break;
                    default:
                        break;
