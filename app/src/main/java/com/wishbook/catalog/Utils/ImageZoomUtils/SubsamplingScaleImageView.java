...
package com.wishbook.catalog.Utils.ImageZoomUtils;
...
import com.wishbook.catalog.Utils.ImageZoomUtils.decoder.CompatDecoderFactory;
import com.wishbook.catalog.Utils.ImageZoomUtils.decoder.DecoderFactory;
import com.wishbook.catalog.Utils.ImageZoomUtils.decoder.ImageDecoder;
import com.wishbook.catalog.Utils.ImageZoomUtils.decoder.ImageRegionDecoder;
import com.wishbook.catalog.Utils.ImageZoomUtils.decoder.SkiaImageDecoder;
import com.wishbook.catalog.Utils.ImageZoomUtils.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
    ...
    // Is q       uick-scale gesture in progress
    ...
    /**
     * By default the View automatically calculates the optimal tile size. Set this to override this, and force an upper limit to the dimensions of the generated tiles. Passing {@link } will re-enable the default behaviour.
     *
     * @param maxPixels
     */
