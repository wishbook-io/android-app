...
public class Fragment_BrokerageOrder_Holders extends GATrackedFragment {
    private View v;
    ...
    public Fragment_BrokerageOrder_Holders() {
   ...
   //     getBrokerageOrder();
    ...
    private void getBrokerageOrder() {
        showProgress();
        HashMap<String, String> headers = StaticFunctions.getAuthHeader(getActivity());
        HttpManager.getInstance(getActivity()).request(HttpManager.METHOD.GETWITHPROGRESS, URLConstants.companyUrl(getActivity(), "brokerage_order", ""), null, headers, true, new HttpManager.customCallBack() {
            @Override
    ...
    private class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public GATrackedFragment getItem(int position) {
            GATrackedFragment result = new Frgment_Tab_Brokerage_Orders("pending", true);
            ;
            switch (position) {
                case 0:
                    // First Fragment of First Tab
                    result = new Frgment_Tab_Brokerage_Orders("pending", true);
                    break;
                case 1:
                    // First Fragment of Second Tab
                    result = new Frgment_Tab_Brokerage_Orders("dispatch", false);
                    break;
                case 2:
                    // First Fragment of Third Tab
                    result = new Frgment_Tab_Brokerage_Orders("cancel", false);
                    break;
