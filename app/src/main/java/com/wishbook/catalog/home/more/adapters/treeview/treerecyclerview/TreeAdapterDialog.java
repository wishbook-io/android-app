 ...
 */
public abstract class TreeAdapterDialog<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TreeAdapterDialog(Context context, List<T> datas, int defaultExpandLevel) throws IllegalAccessException, IllegalArgumentException {
        mContext = context;
        mDatas = datas ;
